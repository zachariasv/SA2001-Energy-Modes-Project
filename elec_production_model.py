...
PRODUCTION_TYPE_CONSTANTS: dict[str, dict[str, float]] = {
    "Wind": {
        "delta_i": 2.0,
        "T_i": 25.0,
        "p_i": 0.25 * 365 * 24 / 26026,
        "e_i": 0.011 * 25 * 0.25 * 365 * 24 / 26026,
    },
    "Nuclear": {
        "delta_i": 7.5,
        "T_i": 40,
        "p_i": 0.70 * 365 * 24 / 66382,
        "e_i": 0.012 * 40 * 0.70 * 365 * 24 / 66382,
    },
    "Hydro": {
        "delta_i": 8.0,
        "T_i": 50,
        "p_i": 0.25 * 365 * 24 / 42461,
        "e_i": 0.024 * 50 * 0.25 * 365 * 24 / 42461,
    },
    "Solar": {
        "delta_i": 0.5,
        "T_i": 25,
        "p_i": 0.15 * 365 * 24 / 71895,
        "e_i": 0.048 * 25 * 0.15 * 365 * 24 / 71895,
    },
}
